...
class App extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            gradeOfCert:'[Certificate grade]________________________',
            wingsLevel:'[Phase No.]________________________',
            phaseNum:'_____________________',
            HPmakeModel: '[Make and Model] ________________________',
            complexMakeModel: '[Make and Model] ________________________',
            pressureMakeModel: '[Make and Model] ________________________',
            twMakeModel: '[Make and Model] ________________________',
            A72_categoryClass: '[category and class]________________________',
            A72_makeModel: '[Make and Model] ________________________',
            A72_limitation:'[limitations]________________________________',
            add_training:'_____________________',
            A73_test:'_____________________',
            A74_addCatClass: '[category and class]________________________',
            A74_practical:'_____________________',
            A75_typeRating:'_____________________',
            A76_practical:'_____________________',
            A76_catClass: '[category and class]________________________',
            A77_practical:'_____________________',
            A78_type:'_____________________',
            A79_makeModel: '[Make and Model] ________________________',
            A79_type:'_____________________',
            A80_type:'_____________________',
            A81_type:'_____________________',
            A82_test:'_____________________',
            A83_type:'_____________________',
            A84_type:'_____________________',
            A85_hours:'[Num. of Hours]___________',
            A85_rating:'_____________________'
        }
            ...
            <div className="App">
                ...
                <Container>
                    ...
                    <FlightInstructorAdditionalInfo
                        ...
                        endorsements={this.state.endorsements}
                    />
                    <SportFlightInstructorAdditionalInfo
                        handleChange={this.handleChange}
                        endorsements={this.state.endorsements}
                    />
